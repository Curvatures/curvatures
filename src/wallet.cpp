...
// Curvatures: total coins staked (non-spendable until maturity)
...
// Curvatures: check 'spent' consistency between wallet and txindex
// Curvatures: fix wallet spent state according to txindex
...
// Curvatures: disable transaction (only for coinstake)
